// -----------------------------------------------------------------------
// <copyright file="InvalidNoncePayloadClaim.cs" company="Evertec Colombia">
...
namespace Everco.Services.Aspen.Client.Tests.Assets
{
    ...
    /// </summary>
    public class InvalidNoncePayloadClaim : InvalidPayloadClaimsManager
    {
        /// <summary>
        /// Impide que se cree una instancia predeterminada de la clase <see cref="InvalidNoncePayloadClaim" />.
        /// </summary>
        private InvalidNoncePayloadClaim()
        {
        }
        ...
        private InvalidNoncePayloadClaim(Func<object> claimBehavior) : base(claimBehavior)
        {
        }
        ...
        public static IPayloadClaimsManager WithClaimBehavior(Func<object> claimBehavior) => new InvalidNoncePayloadClaim(claimBehavior);
        ...
        /// </summary>
        /// <returns>Instancia de <see cref="IPayloadClaimsManager"/> con el comportamiento de personalizado.</returns>
        public static IPayloadClaimsManager AvoidingClaim() => new InvalidNoncePayloadClaim();
        ...
        public override void AddNonceClaim(IDictionary<string, object> payload, string nonce)
        {
            ...
            object nonceClaimValue = this.ClaimBehavior?.Invoke();
            payload.Add(ServiceLocator.Instance.PayloadClaimNames.NonceClaimName, nonceClaimValue);
        }
    }
}